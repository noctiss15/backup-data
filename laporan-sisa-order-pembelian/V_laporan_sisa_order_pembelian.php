...
<script type="text/javascript">
            ...
            function searchDataLaporan() { 
                ...
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Laporan/Sisa-Order-Pembelian/loadData/',
                      data: { id_cabang : document.getElementById("m_cabang_id").value, from_tanggal : document.getElementById("from_tanggal").value, to_tanggal : document.getElementById("to_tanggal").value  }
                    },
                    "columns": [
                      {"data": "no","orderable": false,"searchable": false,  "className": "text-center", "width": "5%"},
                      {"data": "po_customer_nomor"},
                      {"data": "po_customer_tanggal"},
                      {"data": "customer_nama"},
                      {"data": "barang_kode"},
                      {"data": "barang_nama"}
                      // {"data": "barang_ukuran"},
                      // {"data": "po_customerdet_qty", "className":"text-right"},
                      // {"data": "po_customerdet_harga_satuan", "className":"text-right"},
                      // {"data": "dpp", "className":"text-right"},
                      // {"data": "ppn", "className":"text-right"},
                      // {"data": "total", "className":"text-right"},
                      // {"data": "po_customerdet_keterangan", "className":"text-right"}
                      // {"data": "po_customerdet_qty", "className":"text-right"},
            ...
            {
                window.open('<?php echo base_url();?>Laporan/Sisa-Order-Pembelian/Print-Data/'+document.getElementsByName("m_cabang_id")[0].value);
            }
