...
<script type="text/javascript">
            ...
            function searchDataLaporan() { 
                ...
                $('#default-table').DataTable({
                    ...
                    "serverSide": true,
                    ajax: {
                      url: '<?php echo base_url();?>Laporan/Sisa-WO/loadData/',
                      data: { id_cabang : document.getElementById("m_cabang_id").value, from_tanggal : document.getElementById("from_tanggal").value, to_tanggal : document.getElementById("to_tanggal").value   }
                    },
                    "columns": [
                      ...
                      {"data": "barang_nama"},
                      {"data": "order_type"},
                      {"data": "orderdet_qty", "className":"text-right"},
                      {"data": "orderdet_harga_satuan", "className":"text-right"},
                      {"data": "dpp", "className":"text-right"},
                      {"data": "ppn", "className":"text-right"},
                      {"data": "total", "className":"text-right"},
                      {"data": "order_alasan_pembatalan", "className":"text-right"},
            ...
            {
                window.open('<?php echo base_url();?>Laporan/Sisa-WO/Print-Data/'+document.getElementsByName("m_cabang_id")[0].value);
            }
